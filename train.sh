...
torchrun --nproc_per_node=4 applications/efficientvit_sam/train_efficientvit_medsam_model.py applications/efficientvit_sam/configs/efficientvit_sam_xl1.yaml --data_provider.root /om/user/sophiejg/project/tinyml_finalproj/CVPR24-MedSAMLaptopData/train_npz/ --data_provider.dataset medsam --path .exp/efficientvit_sam/efficientvit_sam_xl1 --resume
